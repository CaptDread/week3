...
let freshButt = document.querySelector(`.freshButt`)
...
let buttChecker = function (){
    ...
    let displayResults = function(){
        if(maxCount[0].id === 'murphy'){
            ...
            resImg.setAttribute('src', `../week3/img/murphy.gif`)
            resImg.setAttribute('alt', `Do you want the mustache on or off... Too Bad..`)
            freshButt.style.display = 'block'
            ...
            results.style.display = 'contents'
            resImg.setAttribute('src', `../week3/img/debby.gif`)
            ...
            results.style.display = 'contents'
            resImg.setAttribute('src', `../week3/img/stormy.gif`)
            ...
            results.style.display = 'contents'
            resImg.setAttribute('src', `../week3/img/quin.gif`)
            ...
            results.style.display = 'contents'
            resImg.setAttribute('src', `../week3/img/sparks.gif`)
            ...
            results.style.display = 'contents'
            resImg.setAttribute('src', `../week3/img/marco.gif`)
            ...
            results.style.display = 'contents'
            resImg.setAttribute('src', `../week3/img/hesh.gif`)
            ...
            results.style.display = 'contents'
            resImg.setAttribute('src', '../week3/img/dolphboy.gif');
...
freshButt.addEventListener('click', function(e){
    e.preventDefault()
    console.log(`refresh didnt work`)
